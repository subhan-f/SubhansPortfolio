    ...
    >
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          ...
          >
            <OptimizedImage src="/assets/Subhan.png" alt="Subhan Farrakh Profile" className="absolute inset-0" />
          </motion.div>
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            >
              <a
                href="#projects"
                className="inline-flex items-center justify-center rounded-lg bg-white text-black font-semibold px-5 py-3 hover:bg-gray-200 hover:scale-105 transition-transform"
              >
                View Projects
              </a>
              <a
                href="#contact"
                className="inline-flex items-center justify-center rounded-lg bg-white/5 text-white font-semibold px-5 py-3 border border-white/10 hover:bg-white/20 hover:scale-105 transition-transform"
              >
                Get In Touch
              </a>
            </motion.div>
