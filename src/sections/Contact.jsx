...
function Contact() {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'budget' && value && !/^\d*(\.\d*)?$/.test(value)) return; // Allow digits, optional decimal, and empty
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await emailjs.send(
        EMAILJS_SERVICE_ID, // Fixed: Use the correct constant
        EMAILJS_TEMPLATE_ID, // Fixed: Use the correct constant
        {
          ...formData,
