...
import { experiences as fallback } from '@data/experiences';
    ...
    <ScrollTimeline
      ...
      renderCard={(item) => (
        <div className="relative group">
          ...
          <div className="relative bg-gray-900/50 backdrop-blur-sm border border-white/10 rounded-xl p-6 shadow-lg transition-all duration-300 group-hover:border-[#1cd8d2]/50 group-hover:-translate-y-1">
